...
# Initial map using the RCD heuristic ----
...
# markers remain in the same linkage groups
...
# Manually changing marker orders ----
...
# Function to plot the map with the heatmap
...
# Function to remove markers, run onemap's try_seq and 
# chose the position with LOD = 0
# Warn if there are alternative positions
